...
import * as CANNON from "./canon.min";
import {$t} from "./teal";

var dice_body_material;
...
(function(dice) {
	...
	this.spot_light_color = 0xFFFFFF //0xefdfd5;
	...
	this.dice_box = function(container, dimentions) {
		...
		this.world.addContactMaterial(new CANNON.ContactMaterial(
			desk_body_material, dice_body_material, 0.01, 0.5));
		this.world.addContactMaterial(new CANNON.ContactMaterial(
			barrier_body_material, dice_body_material, 0, 1.0));
		this.world.addContactMaterial(new CANNON.ContactMaterial(
			dice_body_material, dice_body_material, 0, 0.5));
	...
	this.dice_box.prototype.reinit = function(container, dimentions) {
		...
		//var mesh = new THREE.Mesh( new THREE.PlaneGeometry(this.w * 2, this.h * 2, 1, 1), material );
	...
	this.dice_box.prototype.create_dice = function(type, pos, velocity, angle, axis) {
		...
		dice.body = new CANNON.RigidBody(that.dice_mass[type],
			dice.geometry.cannon_shape, dice_body_material);
