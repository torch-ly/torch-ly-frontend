<template>
  <div class="">
    <div class="flex flex-col mb-2">
      Color:
      <input type="color" class="mt-1 w-24 h-6" :value="$store.state.manu.freeDrawing.color"
             @input="onChange">
    </div>
    <div class="">
      Stroke Width:
      <input type="range" min="1" max="50" value="3" class="w-full mt-1" @change="widthChange"
